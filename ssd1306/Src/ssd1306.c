...
void SSD1306_UpdateScreen(void)
{
	...
	//HAL_I2C_Transmit ( SSD1306_I2C, SSD1306_I2C_ADDR, (uint8_t*) &output, 129, SSD1306_I2C_TIMEOUT );

	HAL_I2C_Master_Transmit ( SSD1306_I2C, SSD1306_I2C_ADDR, (uint8_t*) &output, sizeof(output), SSD1306_I2C_TIMEOUT );
	//HAL_I2C_Mem_Write (SSD1306_I2C, SSD1306_I2C_ADDR,0x40, output.SSD1306_Buffer, sizeof(output.SSD1306_Buffer), SSD1306_I2C_TIMEOUT);
}
